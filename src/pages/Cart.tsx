      ...
      <>
        ...
        <div className="mx-auto max-w-4xl p-4 sm:p-6">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-10 text-center shadow-sm">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900">Your cart is empty</h1>
            <p className="mt-2 text-xs sm:text-sm text-slate-600">Add some products to continue shopping.</p>
            <Link
              to="/products"
              className="mt-5 inline-flex rounded-lg bg-sky-600 px-4 py-2.5 text-xs sm:text-sm font-medium text-white transition hover:bg-sky-500"
            >
              Continue Shopping
            </Link>
          </div>
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl p-4 sm:p-6">
        <div className="mb-6">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900">Cart</h1>
        </div>

        <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-[2fr_1fr]">
